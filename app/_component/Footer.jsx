            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="lg:flex lg:items-start lg:gap-8">
                    <div className="text-teal-600">
                        <Image src="/images/studyMaterial.png" alt='logo' width={80} height={100} />
                    </div>
                        ...
                        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form className="w-full">
                                ...
                                >
                                    ...
                                    <button
                                        className="mt-1 w-full bg-primary px-6 py-3 text-sm font-bold uppercase tracking-wide text-black transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                                    >
                                        Subscribe
                                    </button>
                                </div>
                ...
                <div className="mt-8 border-t border-gray-100 pt-8">
                    <div className="sm:flex sm:justify-between">
                        <p className="text-xs text-gray-500">&copy; 2024. StudyMaterial. All rights reserved.</p>
